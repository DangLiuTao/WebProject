<template>
	<div style='text-align: center;'>
		<h1>编辑设备信息</h1>
		<el-row>
		  <el-col :span="12"> <el-input style='width:300px;margin-top: 20px;' v-model='devname'></el-input> </el-col>
		</el-row>
		<el-row>
	  <div class="block">
		<span class="demonstration">投放日期</span>
		<el-date-picker
		  v-model="devdate"
		  type="date"
		  ...
		  <el-col :span="12"> <el-input style='width:300px;margin-top: 20px;'  v-model='devuser'></el-input> </el-col>
		</el-row>
