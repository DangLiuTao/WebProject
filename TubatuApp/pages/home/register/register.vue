		...
		<view class="forget-bg">
			<view class="forget-card">
				...
				<view class="forget-input">
					<input type="password" placeholder="请输入密码(8-16位)" />
				</view>
			</view>
		</view>
...
<style>
	...
	.verify-btn{
		...
		width: 240upx;
		border-radius: 8upx;
		background: linear-gradient(left,#005a5b, #6666CC);
	}
	...
	.landing{
		...
		border-radius: 44upx;
		font-size: 32upx;
		background: linear-gradient(left,#6666CC, #005a5b);
	}
	.forget-btn{
		padding: 10upx 20upx;
		margin-top: 380upx;
	...
	.forget-bg {
		height: 260upx;
		padding: 25upx;
		background: linear-gradient(#6666CC,#005a5b);
	}
</style>
