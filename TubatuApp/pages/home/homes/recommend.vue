	...
	export default {
		data:function() {
			return{
				title:"recommend",
				productList:[
					{ goods_id: 0, img: '../../../static/HM-shophome/img/p1.jpg', name: '热门田园二局装修设计效果图', price: '⭐', slogan:'162' },
					{ goods_id: 1, img: '../../static/HM-shophome/img/p2.jpg', name: '2019精选面积139平现代四居厨房装修实景图', price: '⭐', slogan:'12' },
					{ goods_id: 2, img: '../../static/HM-shophome/img/p3.jpg', name: '精选四居过道日式图片大全', price: '⭐', slogan:'123' },
					{ goods_id: 3, img: '../../static/HM-shophome/img/p4.jpg', name: '一米家居经典设计锻造经典之家', price: '⭐', slogan:'123' },
					{ goods_id: 4, img: '../../static/HM-shophome/img/p5.jpg', name: '精选112平米四居餐厅现代设计效果图', price: '⭐', slogan:'12' },
					{ goods_id: 5, img: '../../static/HM-shophome/img/p6.jpg', name: '欧美风+简配优美装修出自设计师优美灵感', price: '⭐', slogan:'1235' },
				],
			}
		},
		mounted() {
